...
@Path("/translate")
public class LanguageTranslation extends javax.ws.rs.core.Application
{
		                             ...
		                             @FormParam("to") String to_id) throws Exception
	{
		...
		try
		{
			LanguageTranslationRequest request = new LanguageTranslationRequest();
		...
		catch (Exception e)
		{
			...
			return returnHTTPResponse(Response.Status.BAD_REQUEST, "{\"error\": \" Watson service information was not found.  Is the Watson LT service associated with this application? \"}");
		}
